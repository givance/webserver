...
export const WriteInstructionStep = React.forwardRef<{ click: () => Promise<void> }, WriteInstructionStepProps>(
  function WriteInstructionStep(
    ...
    useLayoutEffect(() => {
      if (onSessionDataChange && (chatMessages.length > 0 || generatedEmails.length > 0)) {
        const currentDataString = JSON.stringify({
          chatHistory: chatMessages,
          finalInstruction: previousInstruction || instruction,
          previewDonorIds,
          generatedEmailsCount: generatedEmails.length,
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between pt-4">
                  ...
                  <div className="space-x-2">
                    ...
                    <Button onClick={handleNextClick} disabled={generatedEmails.length === 0} variant="default">
                      Launch Campaign
                    </Button>
                  </div>
                </div>
