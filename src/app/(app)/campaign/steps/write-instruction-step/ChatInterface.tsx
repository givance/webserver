...
import { Mail, Loader2, Edit2, Check, X } from 'lucide-react';
...
interface ChatInterfaceProps {
  ...
  onMessageEdit?: (messageIndex: number, newContent: string) => void;
  editMode?: boolean;
}
                    ...
                    {message.role === 'user' && editingIndex === index ? (
                      <div className="space-y-2">
                        <Textarea
                          ...
                          className="min-h-[60px] text-xs bg-background text-foreground border"
                          autoFocus
                        />
                          ...
                          <Button
                            ...
                            onClick={() => {
                              if (onMessageEdit && editContent.trim()) {
                                onMessageEdit(index, editContent.trim());
                              }
                    ...
                    !isAnyGenerating && (
                      <div className="flex justify-end">
                        <Button
                          size="sm"
                          variant="ghost"
                          className="h-6 px-2 text-xs opacity-60 hover:opacity-100 self-end"
                          onClick={() => {
