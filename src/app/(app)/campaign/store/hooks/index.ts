...
export const useDonorData = () => {
  return useCampaignStore(
    useShallow((state) => ({
      ...
      totalRemainingDonors: state.totalRemainingDonors,
      ...
      setTotalRemainingDonors: state.setTotalRemainingDonors,
      setCanGenerateMore: state.setCanGenerateMore,
...
export const useEmailData = () => {
  return useCampaignStore(
    useShallow((state) => ({
      ...
      setEmailStatuses: state.setEmailStatuses,
...
export const useUIState = () => {
  return useCampaignStore(
    useShallow((state) => ({
      ...
      setIsChatCollapsed: state.setIsChatCollapsed,
      setIsEmailListExpanded: state.setIsEmailListExpanded,
