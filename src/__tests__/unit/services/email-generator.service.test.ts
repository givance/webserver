...
describe('EmailGenerationService', () => {
  ...
  describe('generateEmails', () => {
    ...
    it('should incorporate donor statistics when available', async () => {
      ...
      expect(userMessage.content).toContain('$1,000.00'); // Total donated
    ...
    it('should include person research in generated emails', async () => {
      ...
      expect(result[0].referenceContexts['research-answer']).toBe('Person research: Major philanthropist interested in education');
    });
