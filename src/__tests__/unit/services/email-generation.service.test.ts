import { EmailGenerationService, type GenerateEmailsInput, type DonorInput } from '@/app/lib/services/email-generation.service';
...
describe('EmailGenerationService', () => {
  ...
  describe('generateSmartEmails', () => {
    ...
    it('should throw error if organization not found', async () => {
      ...
      await expect(
        service.generateSmartEmails(input, 'org123', 'user123')
    ...
    it('should handle person research fetch failures gracefully', async () => {
      ...
      expect(logger.warn).toHaveBeenCalledWith(
        expect.stringContaining('Failed to fetch person research for donor 2')
      );
    });
  ...
  describe('enhanceEmail', () => {
    ...
    it('should throw error if email not found', async () => {
      ...
      await expect(
        service.enhanceEmail(enhanceInput, 'org123', 'user123')
      ).rejects.toThrow(TRPCError);
