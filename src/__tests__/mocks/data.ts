...
export const donorFactory = {
  create: (overrides = {}) => ({
    ...
    tags: faker.helpers.arrayElements(['major-donor', 'recurring', 'volunteer', 'board-member'], {
      min: 0,
      max: 3,
    }),
    customFields: {},
...
export const staffFactory = {
  create: (overrides = {}) => ({
    ...
    permissions: faker.helpers.arrayElements(
      ['donors.view', 'donors.edit', 'campaigns.create', 'reports.view'],
      { min: 1, max: 4 }
    ),
    createdAt: faker.date.past(),
    updatedAt: faker.date.recent(),
...
export const listFactory = {
  create: (overrides = {}) => ({
    ...
    tags: faker.helpers.arrayElements(['active', 'inactive', 'vip', 'prospect'], {
      min: 0,
      max: 2,
    }),
    createdAt: faker.date.past(),
...
export const templateFactory = {
  create: (overrides = {}) => ({
    ...
    variables: faker.helpers.arrayElements(['donorName', 'projectName', 'amount', 'date'], {
      min: 0,
      max: 4,
    }),
