  ...
  return (
    ...
    >
      <div
        ...
        className={cn(
          "flex h-svh w-(--sidebar-width) transition-[width] duration-200 ease-linear",
...
function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex flex-none items-center border-b border-gray-200", className)}
      {...props}
    />
  );
}
...
function SidebarFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("mt-auto flex flex-none items-center", className)}
      {...props}
    />
  );
}
...
const sidebarMenuButtonVariants = cva(
  "group/menu-button flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium transition-colors hover:bg-gray-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
  {
    variants: {
      variant: {
...
function SidebarMenuButton({
  ...
  const button = (
    <Comp
      ...
      className={cn(sidebarMenuButtonVariants({ variant, size }), isActive && "bg-gray-100 text-gray-900", className)}
      {...props}
    />
  );
